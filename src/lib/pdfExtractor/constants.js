...
export const JUNK_PATTERNS = new RegExp(
  'TOTAL|SUBTOTAL|DECLAR|CONTRATO|Atendente|Locat|Cidade|Local|Estado|CEP|Fone|Endere|CNPJ|Bairro|Telefone|' +
  'Contato|Data\\s*:|Hora|Refer|EQUILOC|TRANS\\s*OBRA|TARUMA|COMPROVANTE|Observa|Patrim|NOME|RG\\s*:|' +
...
export const ITEM_JUNK_PATTERNS = new RegExp(
  'CONTRATO|Atendente|Locat|Cidade|Local|Estado|CEP|Fone|Endere|CNPJ|Bairro|Telefone|' +
  'Contato|Data\\s*:|Hora|Refer|MANAUS|LOCADORA|CIENTE|DANIFICADO|EXTRAVIADO|TESTADO|' +
  'COMPROVANTE|EQUILOC|TRANS\\s*OBRA|TARUMA|DECLAR|Observa|Patrim|NOME|RG\\s*:',
  'i'
);
